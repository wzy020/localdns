...
import my.tools.localdns.net.Packet.TCPHeader;
import my.tools.localdns.net.TCB.TCBStatus;
...
public class TCPOutput implements Runnable
{
    ...
    public TCPOutput(ConcurrentLinkedQueue<Packet> inputQueue, ConcurrentLinkedQueue<ByteBuffer> outputQueue,
                     Selector selector, ReentrantLock tcpSelectorLock, LocalDNSService vpnService)
    {
